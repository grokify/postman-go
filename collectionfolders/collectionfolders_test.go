package collectionfolders_test
...
func newService(t *testing.T, handler http.HandlerFunc) (*collectionfolders.Service, *httptest.Server) {
	t.Helper()
	...
	return collectionfolders.New(apiClient), srv
}
...
func TestGet(t *testing.T) {
	svc, srv := newService(t, func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodGet || r.URL.Path != "/collections/c1/folders/r1/comments" {
...
func TestCreate(t *testing.T) {
	svc, srv := newService(t, func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodPost || r.URL.Path != "/collections/c1/folders/r1/comments" {
			t.Errorf("unexpected request: %s %s", r.Method, r.URL.Path)
		}
	...
	got, err := svc.Create(context.Background(), "c1", "r1", &collectionfolders.CreateInput{
		Body:     "hello",
		ThreadID: 5,
		Tag:      &collectionfolders.Tag{Type: "user", ID: "u1"},
	})
	if err != nil {
...
func TestUpdate(t *testing.T) {
	svc, srv := newService(t, func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodPut || r.URL.Path != "/collections/c1/folders/r1/comments/2" {
			t.Errorf("unexpected request: %s %s", r.Method, r.URL.Path)
		}
	...
	got, err := svc.Update(context.Background(), "c1", "r1", 2, &collectionfolders.UpdateInput{Body: "updated"})
	if err != nil {
...
func TestDelete(t *testing.T) {
	svc, srv := newService(t, func(w http.ResponseWriter, r *http.Request) {
		if r.Method != http.MethodDelete || r.URL.Path != "/collections/c1/folders/r1/comments/2" {
			t.Errorf("unexpected request: %s %s", r.Method, r.URL.Path)
		}
...
func TestGetNotFound(t *testing.T) {
	svc, srv := newService(t, func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"status": 404, "title": "Not Found", "type": "about:blank", "instance": "/collections/c1/folders/r1/comments"}`))
	})
	defer srv.Close()
...
func TestCreateUnauthorized(t *testing.T) {
	...
	_, err := svc.Create(context.Background(), "c1", "r1", &collectionfolders.CreateInput{Body: "hi"})
	if err == nil {
		t.Fatal("expected error, got nil")
	}
	var apiErr *postmanerr.APIError
...
func TestUpdateForbidden(t *testing.T) {
	...
	_, err := svc.Update(context.Background(), "c1", "r1", 2, &collectionfolders.UpdateInput{Body: "hi"})
	if err == nil {
		t.Fatal("expected error, got nil")
	}
	var apiErr *postmanerr.APIError
